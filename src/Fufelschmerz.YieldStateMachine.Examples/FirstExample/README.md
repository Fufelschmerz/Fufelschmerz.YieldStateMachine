# Конечный автомат yield методов возвращающий интерфейс `IEnumerable`

Полный разбор преобразования следующего кода в конечный автомат с подробными комментариями.
